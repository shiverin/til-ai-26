"""CV server with shutdown hook to flush phone-home buffer."""
import base64
...
def _flush():
    """Flush any buffered phone-home payload on shutdown."""
    if hasattr(manager, "flush_phone_home"):
        manager.flush_phone_home()

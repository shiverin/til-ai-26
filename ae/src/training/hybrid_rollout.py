...
def collect_hybrid_rollout(actor, learner_slots, num_episodes, seed0,
    ...
    for ep in range(num_episodes):
        ...
        if opponent_names:
            ...
            opp_agents = {s: RandomAgent() for s in opp_slots}
        ...
        per_slot_run = {s: [] for s in learner_slots}
        prev_tr = {s: None for s in learner_slots}
        ...
        for s in learner_slots:                 # append each slot's run contiguously
